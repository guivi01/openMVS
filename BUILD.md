...
#OpenMVG (Optional)
sudo apt-get -y install libxxf86vm1 libxxf86vm-dev libxi-dev libxrandr-dev graphviz
...
mkdir openMVS_build
cd openMVS_build
cmake . ../openMVS -DCMAKE_BUILD_TYPE=Release -DVCG_DIR="~/vcglib" -DOpenCV_CAN_BREAK_BINARY_COMPATIBILITY=OFF

#If you want to use OpenMVS as shared library, add to the cmake command:
-DBUILD_SHARED_LIBS=ON

#If you want to use OpenMVG as optional third party library, add to the cmake command:
-DOpenMVG_DIR:STRING="~/openMVG_build/openMVG_install/share/openMVG/cmake/"
